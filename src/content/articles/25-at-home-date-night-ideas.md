...
By the Weekend Basecamp team • Updated March 2026 • 20 min read
...
The setup is simple: hot bath or shower first, then face masks, then hand or foot massages. Put on something calm — ambient music, nature sounds, whatever makes you feel like you're not in your own bathroom. Dim the lights. The [**LED candles**](https://www.amazon.com/s?k=LED+flameless+candles+set&tag=weekendbasecamp-20) come back into play here. Buy a decent massage oil and some sheet masks from the drugstore. The whole thing costs under $30 and honestly, by the time you're done, you feel like you just spent $400 at an actual spa. It's one of the best ways we've found to physically decompress together, and it's become a monthly ritual we both genuinely look forward to.
...
[Add Cozy Night Essentials to Cart →](https://www.amazon.com/gp/aws/cart/add.html?AssociateTag=weekendbasecamp-20&ASIN.1=B0CWP7M285&Quantity.1=1&ASIN.2=B09BFDM5QD&Quantity.2=1)

> "You don't need a reservation to have a great evening. You need intention." 
...
💰 ~$0 (after setup) ⏱ 2–3 hours

There's a specific kind of evening that happens when you combine candles, a good speaker playing lo-fi, and nowhere to be tomorrow. It doesn't require planning. It doesn't require conversation. It just requires showing up outside with a drink and sitting down. We stumbled into this accidentally one October — dragged chairs out to the backyard, lit a ring of tea lights, and ended up talking for three hours about things we hadn't discussed in years. Now it's a near-weekly thing.
...
6:30 PM — Move chairs outside. Lay out a blanket. Light the candles.
6:45 PM — Set up JBL Clip 4 with lo-fi playlist. Pour drinks.
7:00 PM — Sit down. Resist the urge to check your phone
...
9:00 PM — Blow out the candles when the evening feels done. Stay until it does.

**Quick shopping list:** Tea light candles, s'mores supplies (graham crackers, chocolate, marshmallows), drinks of choice.

**Prep-ahead tip:** Set out the candles and chairs before dinner. Clip the speaker somewhere you'll both hear it without it being in the way.
...
We use a [**mini projector (~$150)**](https://www.amazon.com/s?k=mini+portable+projector&tag=weekendbasecamp-20) that's about the size of a coffee mug. It streams directly from your phone. The first time we set it up, we watched an old Hitchcock film and ate popcorn on a blanket in our backyard and it was, genuinely, more fun than the last five times we'd gone to an actual movie theater. The [**JBL Charge 5**](https://www.amazon.com/dp/B08X4YMTPM?tag=weekendbasecamp-20) handles the audio — Bluetooth from the laptop, plenty loud for outdoor use.
...
💰 ~$40 (groceries + candles) ⏱ 2–3 hours
...
**Pro tip:** The morning coffee ritual works even better with a scented candle on the table between you. A single lit candle adds just enough warmth and visual focus to make the whole thing feel intentional — and costs about $3.
...
[Add Backyard Romance Kit to Cart →](https://www.amazon.com/gp/aws/cart/add.html?AssociateTag=weekendbasecamp-20&ASIN.1=B0B7B7R8HL&Quantity.1=1&ASIN.2=B08X4YMTPM&Quantity.2=1)
...
We started doing this during a period when we couldn't afford to go out, and it quickly became something we preferred to going out. There's a vulnerability to dancing badly with someone that breaks through the kind of guardedness that accumulates in long relationships. The [**JBL Charge 5 (~$140)**](https://www.amazon.com/dp/B08X4YMTPM?tag=weekendbasecamp-20) fills a room well enough that it actually feels like being somewhere. Start with something you both know — something from your early dating days, maybe — and let the playlist do the work. The only rule: no phones, no checking the time, no sitting down until you're both genuinely tired.
...
4:00 PM — Set up games on the table: Codenames, playing cards, one more of your choice
...
7:15 PM — Order food to celebrate. Rehash the highlights.

**Quick shopping list:** Codenames, playing cards, dice, drinks, snacks, something for dinner after.

**Prep-ahead tip:** Set up all the games before round one. Make a bracket and draw it on paper. Prep a “trophy” — a silly hat, a hand-drawn certificate, whatever makes it funny.

Want everything for these date nights?

[Add Active Date Kit to Cart →](https://www.amazon.com/gp/aws/cart/add.html?AssociateTag=weekendbasecamp-20&ASIN.1=B0BXDVHX48&Quantity.1=1&ASIN.2=B0DZSJDP3V&Quantity.2=1&ASIN.3=B01M1LQDYA&Quantity.3=1&ASIN.4=B08X4YMTPM&Quantity.4=1)

> "We stopped waiting for the weekend to reconnect. Now every Tuesday night is ours." 
...
[**Catan (~$35)**](https://www.amazon.com/s?k=Catan+board+game&tag=weekendbasecamp-20) was our entry point and it remains in regular rotation. The trading mechanic means you're constantly negotiating, which leads to alliances, betrayals, and the kind of playful trash talk that reminds you why you liked this person in the first place. [**Ticket to Ride (~$30)**](https://www.amazon.com/s?k=Ticket+to+Ride+board+game&tag=weekendbasecamp-20) is our other go-to — it's less confrontational and more strategic, perfect for nights when you want competition without the emotional risk of blocking someone's longest road. We play every Tuesday now. It's the most protected time on our calendar.
...
[Add Creative Night Kit to Cart →](https://www.amazon.com/gp/aws/cart/add.html?AssociateTag=weekendbasecamp-20&ASIN.1=B0BXDR63VP&Quantity.1=1&ASIN.2=B08X4YMTPM&Quantity.2=1)

## 5\. Deep Connection

For the nights when you want to go beyond fun and actually learn something new about the person you've been sharing a bathroom with for years.

### The Question Card Evening That Gets Real

💰 ~$15 ⏱ 2 hours

After testing about a dozen conversation card games with three different couples over the past year, [**We're Not Really Strangers (~$15)**](https://www.amazon.com/s?k=We%27re+Not+Really+Strangers+card+game&tag=weekendbasecamp-20) is the one we keep coming back to. The questions escalate gradually — the first level feels like a fun icebreaker, the second level gets personal, and by level three you're having the kind of conversation that used to only happen at 2 AM after too much wine. Except now it's 8 PM on a Thursday and you're completely sober and it's even better.

What makes this different from just "asking each other deep questions" is the structure. The cards remove the awkwardness of choosing what to ask — you just flip one over and answer honestly. Some of them are deceptively simple. "What do you think I'm most afraid of?" sounds easy until you actually have to say it out loud to the person. [**TableTopics Couples (~$25)**](https://www.amazon.com/s?k=TableTopics+Couples+conversation+cards&tag=weekendbasecamp-20) is our runner-up — lighter in tone, better for nights when you want connection without emotional heavy lifting. We alternate between the two depending on the mood. Both are worth owning.
...
[Add Deep Connection Kit to Cart →](https://www.amazon.com/gp/aws/cart/add.html?AssociateTag=weekendbasecamp-20&ASIN.1=B0BXDR63VP&Quantity.1=1)

> "The best relationships aren't the ones where you never run out of things to do. They're the ones where doing nothing together still feels like something." 

### Get Everything You Need

We've put together curated kits with everything mentioned in this guide — one click adds them all to your Amazon cart.

[Browse Our Couple Kits →](https://weekendbasecamp.com/collections)

Couple+Cozy • Couple+Active • Couple+Deep • Couple+Celebratory
