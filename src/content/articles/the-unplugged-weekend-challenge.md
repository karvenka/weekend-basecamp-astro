...
A [Leuchtturm1917 hardcover notebook (~$25)](https://www.amazon.com/s?k=leuchtturm1917+notebook+hardcover&tag=weekendbasecamp-20) is the one worth getting if you don't already have a preference. The paper is good, the pages are numbered, it lies flat when open. If you do this regularly, these notebooks become artifacts of time spent together.

<div style="display:flex;gap:12px;align-items:center;padding:12px 16px;margin:16px 0;background:#fff;border:1px solid #e8dfd3;border-radius:8px"><div style="width:60px;height:60px;flex-shrink:0;background:#f8f6ea;border-radius:4px;display:flex;align-items:center;justify-content:center;font-size:24px">🎁</div><div style="flex:1;min-width:0"><div style="font-size:13px;font-weight:700;color:#1a1a1a;line-height:1.3">Leuchtturm1917 hardcover notebook</div><div style="font-size:15px;font-weight:800;color:#0f1111;margin-top:2px">$25</div></div><a href="https://www.amazon.com/s?k=leuchtturm1917+notebook+hardcover&tag=weekendbasecamp-20" target="_blank" rel="noopener noreferrer nofollow" style="display:inline-block;padding:6px 14px;background:#febd69;color:#0f1111;font-size:11px;font-weight:700;border-radius:4px;text-decoration:none;white-space:nowrap;flex-shrink:0">View on Amazon</a></div>
...
[Patchwork (~$25)](https://www.amazon.com/s?k=patchwork+board+game+2+player&tag=weekendbasecamp-20) is the best two-player board game for couples in this category. It's a tile-laying puzzle game about quilting (sounds boring, is not boring). Games take about 30 minutes, it's immediately intuitive, and it generates just enough competition to be interesting without anyone getting actually upset.

<div style="display:flex;gap:12px;align-items:center;padding:12px 16px;margin:16px 0;background:#fff;border:1px solid #e8dfd3;border-radius:8px"><img src="https://images-na.ssl-images-amazon.com/images/P/B00RCCAPPE.01._SCLZZZZZZZ_SL250_.jpg" alt="Patchwork" style="width:60px;height:60px;object-fit:contain;flex-shrink:0;border-radius:4px;background:#f8f6ea" onerror="this.style.display='none'" /><div style="flex:1;min-width:0"><div style="font-size:13px;font-weight:700;color:#1a1a1a;line-height:1.3">Patchwork</div><div style="font-size:15px;font-weight:800;color:#0f1111;margin-top:2px">$25</div></div><a href="https://www.amazon.com/s?k=patchwork+board+game+2+player&tag=weekendbasecamp-20" target="_blank" rel="noopener noreferrer nofollow" style="display:inline-block;padding:6px 14px;background:#febd69;color:#0f1111;font-size:11px;font-weight:700;border-radius:4px;text-decoration:none;white-space:nowrap;flex-shrink:0">View on Amazon</a></div>

Alternatively, [Hive (~$28)](https://www.amazon.com/s?k=hive+board+game&tag=weekendbasecamp-20) is a two-player abstract strategy game with no luck involved. Like chess but faster to learn and less baggage.

<div style="display:flex;gap:12px;align-items:center;padding:12px 16px;margin:16px 0;background:#fff;border:1px solid #e8dfd3;border-radius:8px"><div style="width:60px;height:60px;flex-shrink:0;background:#f8f6ea;border-radius:4px;display:flex;align-items:center;justify-content:center;font-size:24px">🎁</div><div style="flex:1;min-width:0"><div style="font-size:13px;font-weight:700;color:#1a1a1a;line-height:1.3">Hive</div><div style="font-size:15px;font-weight:800;color:#0f1111;margin-top:2px">$28</div></div><a href="https://www.amazon.com/s?k=hive+board+game&tag=weekendbasecamp-20" target="_blank" rel="noopener noreferrer nofollow" style="display:inline-block;padding:6px 14px;background:#febd69;color:#0f1111;font-size:11px;font-weight:700;border-radius:4px;text-decoration:none;white-space:nowrap;flex-shrink:0">View on Amazon</a></div>

## The Music Situation

[A Bose SoundLink Mini portable speaker (~$99)](https://www.amazon.com/s?k=bose+soundlink+mini+bluetooth+speaker&tag=weekendbasecamp-20) loaded up with offline Spotify playlists before the weekend starts handles the music without requiring you to look at a screen. Set the playlist, put the phone face down, let the speaker run.

<div style="display:flex;gap:12px;align-items:center;padding:12px 16px;margin:16px 0;background:#fff;border:1px solid #e8dfd3;border-radius:8px"><img src="https://images-na.ssl-images-amazon.com/images/P/B074VF647Y.01._SCLZZZZZZZ_SL250_.jpg" alt="A Bose SoundLink Mini portable speaker" style="width:60px;height:60px;object-fit:contain;flex-shrink:0;border-radius:4px;background:#f8f6ea" onerror="this.style.display='none'" /><div style="flex:1;min-width:0"><div style="font-size:13px;font-weight:700;color:#1a1a1a;line-height:1.3">A Bose SoundLink Mini portable speaker</div><div style="font-size:15px;font-weight:800;color:#0f1111;margin-top:2px">$99</div></div><a href="https://www.amazon.com/s?k=bose+soundlink+mini+bluetooth+speaker&tag=weekendbasecamp-20" target="_blank" rel="noopener noreferrer nofollow" style="display:inline-block;padding:6px 14px;background:#febd69;color:#0f1111;font-size:11px;font-weight:700;border-radius:4px;text-decoration:none;white-space:nowrap;flex-shrink:0">View on Amazon</a></div>
